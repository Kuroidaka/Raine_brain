 ...
 *
 */
export const loadTextFile = async (relativePath: string): Promise<string> => {
 ...
 */
export const generateAndAttachEmbeddings = async (
 ...
 *
 */
export const calculateCosineDistancesAndSignificantShifts = (
...
async function rag(documents: any[], collectionName: string = "agentic-chunks") {
  ...
  const result = await chain.invoke("What skill from this CV");
